...
public class AdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<form  action=\"./AddProduct\">");
		response.getWriter().println("<input name=\"Brand\" type=\"text\" value=\"Brand\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"Model\" type=\"text\" value=\"Model\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"Properties\" type=\"text\" value=\"Properties\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"Price\" type=\"number\" step=\"0.01\" value=\"Price\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"SubCategory\" type=\"text\" value=\"SubCategory\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"Category\" type=\"text\" value=\"Category\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input name=\"Photo\" type=\"text\" value=\"Photo\" />");
		response.getWriter().println("</div>");
		response.getWriter().println("<div>");
		response.getWriter().println("<input type=\"submit\" value=\"Create Product\" class=\"submitButton\"/><br />");
		response.getWriter().println("</div>");
		response.getWriter().println("</form>");
